            ...
            <div class="col-md-3">
                ...
                <select name="menu_id" class="form-control" id="menu">
                    ...
                    @foreach($menus as $menu)
                        <option value="{{ $menu->id }}">{{ $menu->{'name_'.$lang } }}</option>
                    @endforeach
                </select>
            </div>
            <div class="col-md-9">
                ...
                <div class="tab-pane fade" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab">
                    <div class="container">
                        <div class="form-group p-2">
                            ...
                            <input type="text" id="form1" class="form-control w-100 @error('title_cyrl') is-invalid @enderror " name="title_cyrl" value="{{old('title_cyrl')}}">
                            @error('title_cyrl')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        ...
                        <div class="form-group p-2">
                            ...
                            <textarea name="description_cyrl" cols="30" rows="5" class="form-control @error('description_cyrl') is-invalid @enderror">{{old('description_cyrl')}}</textarea>
                        ...
                        <div class="form-group p-2">
                            <textarea id="post_body0" name="body_cyrl" cols="30" rows="5" class="form-control @error('body_cyrl') is-invalid @enderror">{{old('body_cyrl')}}</textarea>
                            @error('body_cyrl')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
