        ...
        <div class="container">
            <form action="{{ route('roles.update', ['role' => $role]) }}" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" placeholder="example: Operator" autofocus autocomplete="off" value="{{ old('name', $role->name) }}">
                    @error('name')
