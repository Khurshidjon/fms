...
<h4 class="text-center font-weight-bold text-uppercase">Yuk Tashish Xizmati</h4>
    <div class="row">
      <div class="col-md-4">
          <div class="card p-2" style="width:100%;height:350px"  >
              <img src="{{asset('frontend/img/yuk.jpg')}}" style="width:100%;height:350px;overflow:hidden" alt="">
          </div>
      </div>
      <div class="col-md-8">
    ...
    <div class="row mt-5 ml-1">
        <div class="col-md-12">
            <p><h6 class="text-uppercase font-weight-bold">LOGISTIKA BO'LIMINING TELEFON RAQAMI</h6></p>
            <p>
                <h6 class="text-uppercase font-weight-bold"><a href="tel: +99894 123 45 67">+99894 123 45 67</a></h6>
            </p>
        </div>
    </div>
</div>
